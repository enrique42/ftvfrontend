...
<script id="janela-tweets" type="x-tmpl-mustache">
	<div class="tweet-single">
		...
		<div class="dados-tweet">
			...
			<a href="#" class="link-tweet salvar-tweet orange-text text-darken-4">Salvar Tweet</a>
		</div>				
	</div>
</script>
...
<script id="janela-lista-sinais" type="x-tmpl-mustache">
	<div class="sinais-single">
		<div class="sinal-linha sl-simples">
			<div class="sinal-texto sinal-texto-titulo"><span>Nome: </span>{{nome}} - <a href="#" class="editar-sinal">Clique para editar este sinal</a></div>	
		</div>
